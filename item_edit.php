<?php
    ...
    $edit_brand_id=$item['brand_id'];
    $edit_subcategory_id=$item['subcategory_id']
?>
...
<!--
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="number" class="form-control" id="price_id" name="price" value="<?= $item['price']?>">
                            </div>
                        </div>
                                        ...
                                        if(isset($edit_subcategory_id)){
                                           foreach($rows as $subcategory){
                                            ...
                                            if($edit_subcategory_id==$subcategory_id){
                                                echo "<option value='$subcategory_id' selected='selected'>$name</option>";
                                            }else{
                                                echo "<option value='$subcategory_id'>$name</option>";
                                            }
