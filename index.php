	...
	<div class="container mt-5 px-5">
			...
			<div class="col-12">
				<div class="MultiCarousel" data-items="1,3,5,6" data-slide="1" id="MultiCarousel"  data-interval="1000">
		            <div class="MultiCarousel-inner">
		                ...
		                <div class="item">
		                    <div class="pad15">
		                    	<a href="item_detail.php?id=<?=$di_id;?>" class="text-dark">
								...
								<a class="addtocartBtn text-decoration-none" data-id="<?=$di_id?>" data-name="<?=$di_name?>" data-price="<?=$di_price?>" data-discount="<?=$di_discount?>" data-photo="<?=$di_photo?>" data-codeno="<?=$di_codeno?>">Add to Cart</a>
			...
			<div class="col-12">
				<div class="MultiCarousel" data-items="1,3,5,6" data-slide="1" id="MultiCarousel"  data-interval="1000">
		            <div class="MultiCarousel-inner">
		                ...
		                <div class="item">
		                    <div class="pad15">
		                    	<a href="item_detail.php?id=<?=$si_id;?>" class="text-dark">
								...
								<a class="addtocartBtn text-decoration-none" data-id="<?= $si_id; ?>" data-name="<?= $si_name; ?>" data-price="<?= $si_price; ?>" data-discount="<?= $si_discount; ?>" data-photo="<?= $si_photo; ?>" data-codeno="<?= $si_codeno; ?>">Add to Cart</a>
		            ...
		            <div class="MultiCarousel-inner">
		                ...
		                <div class="item">
		                    <div class="pad15">
								...
								<a class="addtocartBtn text-decoration-none" data-id="<?= $ri_id; ?>" data-name="<?= $ri_name; ?>" data-price="<?= $ri_price; ?>" data-discount="<?= $ri_discount; ?>" data-photo="<?= $ri_photo; ?>" data-codeno="<?= $ri_codeno; ?>">Add to Cart</a>
	    ...
	    <section class="customer-logos slider mt-5">
	    	<?php 
	      	...
	      	<div class="slide">
	      		<a href="">
		      		<img src="<?= $bphoto; ?>" class="img-fluid my-md-3">
		      	</a>
	      	</div>
	      <?php } ?>
	   	</section>
